...
XWPFDocument doc = new XWPFDocument();
               ...
               // System.out.println("webInfPath "+webInfPath);
                File file = new File("D:\\QuestionPaper.doc");
		...
		try {
			...
			c = DriverManager.getConnection("jdbc:mysql://localhost:3306/gr11?serverTimezone=EST5EDT","root","root");
	...
	for(int j=1;j<=5;j++)
	{
		...
		String sql = "SELECT U"+j+" FROM `"+SubjectfromSession+"` ORDER by RAND() limit 3 ";
